    ...
    <div className=" bg-black pb-10">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between p-6 md:p-12">
        <div className="text-left md:w-1/2 w-full mb-6 md:mb-0 sm:mt-0 mt-5">
          <h1 className="text-4xl sm:text-5xl md:text-5xl font-bold mb-4 text-[#D388F8]">Create Stories Together</h1>
          <p className="text-lg text-white sm:text-xl mb-6">Collaborate with others to craft imaginative tales. Share your creativity and watch your story evolve with each contribution. Begin your storytelling adventure today!</p>
          ...
          <p className="mt-4 text-base sm:text-lg text-white">⭐⭐⭐⭐⭐ 4.5 / 5 (<span className='text-[#D388F8]'>Join the storytelling community today</span>)</p>
        </div>
